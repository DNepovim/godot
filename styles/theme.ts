...
export const min = (breakpoint: "s" | "m" | "l") => `(min-width: ${theme.breakpoints[breakpoint]}px)`;
export const max = (breakpoint: "s" | "m" | "l") => `(min-width: ${theme.breakpoints[breakpoint] - 1}px)`;
